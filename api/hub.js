// ProofMark verify + admin + download in one module (Vercel serverless)
// Routes:
...
const PEPPER = process.env.ACCESS_PEPPER || 'proofmark-pepper-56fdb1df';

const FILES = [
  '01-the-proofmark-system.pdf',
  '02-the-slop-list.pdf',
  '03-the-five-passes-workbook.pdf',
  '04-the-voice-fingerprint-kit.pdf',
  '05-the-rewrite-library.pdf',
  '06-the-prompt-and-system-pack.pdf',
  '07-by-channel-playbooks.pdf',
  '08-the-tracker-and-proofmark-card.pdf',
];
